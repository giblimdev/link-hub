...
const projects: Project[] = [
  {
    ...
    url: "https://fast-book-in.vercel.app/",
    image: "/images/new-horizon-preview.png",
    status: "completed",
    progress: 100,
  ...
  },
  {
    ...
    image: "/images/cs50-blog-online-preview.png",
    status: "in-progress",
    progress: 85,
  ...
  },
  {
    ...
    image: "/images/project-manager-preview.pnj",
    status: "completed",
    progress: 100,
...

  {
    ...
    title: "GrandConnect",
    description:
      "Assistant intergénérationnel intelligent qui connecte, protège et valorise les seniors tout en rassurant leurs familles grâce à l'IA.",
    url: "https://fami-link.vercel.app/",
    image: "/images/GrandConnect-preview.jpg",
    status: "completed",
    progress: 100,
    lastUpdate: "2024-11-30",
    features: [
      "Interface vocale intelligente adaptée aux seniors",
      "Détection automatique des chutes via capteurs intégrés",
      "Bouton SOS physique et virtuel",
      "Signal 'tout va bien' quotidien automatique",
      "Alertes médicales prédictives avec IA",
      "Messages vocaux avec transcription automatique",
      "Appels simplifiés d'un bouton",
      "Partage de photos commentées par voix",
      "Connexion avec objets connectés santé",
      "Rappels médicaments personnalisés",
      "Suivi automatique des rendez-vous médicaux",
      ...
      "Tendances de bien-être à long terme",
      "Coordination familiale multi-utilisateurs",
      "Système de reporting pour aidants professionnels",
      "Communication intergénérationnelle facilitée",
      "Assistant personnel IA pour seniors",
      "Téléassistance 24/7 (formule premium)",
      "Documentation automatique des interactions",
      "Dashboard famille avec métriques de bien-être",
      "Prévention des situations d'urgence",
      "Interface accessible et bienveillante",
    ],
    techStack: [
...

  {
    ...
    image: "/images/fm-online-preview.png",
    status: "in-progress",
    progress: 85,
